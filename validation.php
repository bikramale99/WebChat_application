...
if($username=="" || $password=="") {
	header("location: chatindex.php?error=1");
	die();
} else {
	...
	header("location: chatindex.php?error=1"); // if user and password didn't mttch send back to index with varibale via GET method. 
	die();
}
?>