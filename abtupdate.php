							...
							<table>
								<tr>
									...
									if (isset($_POST["submit"])) {
										...
										if ($error == "") {
												$sql = " UPDATE about set  heading='$heading', about_description='$about_description' WHERE about_id='$id' ";
											}
								...
								<tr>
									...
									<td><textarea class="form-control" name="about_description" id="description" cols="45" rows="5"><?php echo $about_description; ?></textarea></td>
								</tr>
